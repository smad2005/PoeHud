                ...
                foreach (var statement in statements)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                poeClassCondition = poeClassContext.@params().strValue().Any(y => className.Contains(GetRawText(y)));
                            }
                            else
                            {
                                ...
                                {
                                    poeBaseTypeCondition = poeBaseTypeContext.@params().strValue().Any(y => basename.Contains(GetRawText(y)));
                                }
                                else
                                {
